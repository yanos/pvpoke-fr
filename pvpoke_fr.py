...
<head>
  ...
  <style>
    *{{box-sizing:border-box;margin:0;padding:0}}
    body{{font-family:'Segoe UI',sans-serif;background:#0d1b2a;color:#e0e6f0;padding:1.5rem .5rem}}
...
<head>
  ...
  <style>
    *{{box-sizing:border-box;margin:0;padding:0}}
    ...
    .controls{{max-width:900px;margin:0 auto 1.5rem;background:#152033;border:1px solid #1e3350;
               border-radius:14px;padding:.9rem;display:flex;flex-wrap:wrap;gap:.8rem}}
    ...
    .inline-fields{{display:flex;flex-wrap:wrap;gap:.5rem}}
    /* flex-basis is the wrap trigger: below ~10rem each move dropdown drops onto its own line
       instead of being squeezed (move names are long) or pushed outside the panel. */
    .inline-fields input,.inline-fields select{{width:auto;flex:1 1 10rem;min-width:0}}
    ...
    .league-stat-header .league-stat-name{{font-weight:700;color:#4a6d94;font-size:.7rem;
    ...
    @media(max-width:480px){{
      ...
      .league-stat-header .league-stat-value,
      .league-stat-header .league-stat-name{{font-size:.58rem}}
    }}
