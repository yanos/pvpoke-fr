...
- Renders one panel per league stacked vertically (`.league-panel`, no tabs) showing sprite, name, moveset, level, CP, and global rank — French names/sprites from `i18n_fr.json`.
